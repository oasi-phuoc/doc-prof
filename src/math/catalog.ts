...
export const exerciseTypes: ExerciseType[] = [
  ...
  t(
    ...
    'jeux-cartes',
    'Vocabulaire',
    'Cartes image + mot (12 cartes) ; verso = mot + logo ClairFLE + nom de série.',
  ...
  t(
    ...
    'jeux-cartes',
    'Devinettes',
    'Cartes recto-verso : mot + image et indices ; verso brandé logo ClairFLE + série.',
  ...
  t(
    ...
    'jeux-cartes',
    'Mémory',
    'Paires image / mot au recto ; verso = logo ClairFLE + nom de série (6 paires).',
  ...
  t(
    ...
    'jeux-cartes',
    'Intrus',
    '12 cartes (5 mots inclinés) ; verso = logo ClairFLE + nom de série.',
    'Entourez l’intrus dans chaque carte.',
    'texte',
    { preferredColumns: 1 },
  ),
  t(
