...
const ADJ_ER: Record<string, readonly string[]> = {
  ...
  habiter: ['habite/verbe dans/preposition une/determinant petite/adjectif maison/nom', 'habite/verbe dans/preposition un/determinant grand/adjectif appartement/nom'],
